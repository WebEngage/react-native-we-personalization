...
class PersonalizationBridge: RCTEventEmitter {
  ...
  override init() {
    ...
    PersonalizationBridge.emitter = self
      print(WEGConstants.TAG+" Inside PersonalizationBridge")
...
// campaigns
    @objc func registerCampaignCallback() {
        print(WEGConstants.TAG+" WET: registerCampaignCallback called ")
...
//    unRegisterForCampaigns
    @objc func unRegisterCampaignCallback() -> Void {
        print(WEGConstants.TAG+" WET: unRegisterForCampaigns called")
    ...
    @objc func userWillHandleDeepLink(_ doesUserHandleCallback: Bool) {
        print(WEGConstants.TAG+" WET: userWillHandleDeepLink called - \(doesUserHandleCallback)")
