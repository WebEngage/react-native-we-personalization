package com.webengage.sdk.android.utils.htmlspanner.css;
...
import com.webengage.sdk.android.utils.htmlspanner.cssparser.PropertyValue;
import com.webengage.sdk.android.utils.htmlspanner.cssparser.Rule;
import com.webengage.sdk.android.utils.htmlspanner.cssparser.Selector;
...
public class CSSCompiler {
    ...
    public static CompiledRule compile(Rule rule, HtmlSpanner spanner ) {
        ...
        for ( PropertyValue propertyValue: rule.getPropertyValues() ) {
            //Log.i("HtmlSpanner","compile propertyValue "+propertyValue);
    ...
    private static int getHexColor(int[] color) {
    ...
    public static StyleUpdater getStyleUpdater( final String key, final String value) {
        ...
        if ( "color".equals(key)) {
            try {
                if(value.contains("rgb")){
                    String colorValueinRGB = value.replaceAll(" ","");
                    colorValueinRGB = colorValueinRGB.replace("rgb(","");
                    colorValueinRGB = colorValueinRGB.replace(")","");
                    String[] colorStrArr = colorValueinRGB.split(",");
                    int[] colorIntArray = new int[3];
                    for (int i=0;i<colorStrArr.length;i++) {
                        colorIntArray[i]= Integer.parseInt(colorStrArr[i]);
                    }
                    final Integer color = getHexColor(colorIntArray);
                ...
                Logger.e(WebEngageConstant.TAG, "Can't parse colour definition: " + value);
                return null;
            }
        }
        ...
        if ( "align".equals(key) || "text-align".equals(key)) {
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Can't parse alignment: " + value);
                return null;
            }
        }
        ...
        if ( "font-weight".equals(key)) {
            ...
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Can't parse font-weight: " + value);
                return null;
            }
        }
        ...
        if ( "font-style".equals(key)) {
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Can't parse font-style: " + value);
                return null;
            }
        }
        ...
        if ( "font-size".equals(key)) {
            ...
            if ( styleValue != null ) {
                ...
                if(styleValue.getUnit().equals(StyleValue.Unit.PT)){
                    int pxl= spToPx((float)styleValue.getIntValue());
                    styleValue.setIntValue(pxl);
                }
//                else{
...
//                }
        ...
        if ( "display".equals( key ) ) {
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Can't parse display-value: " + value );
                return null;
            }
        }
        ...
        if ( "border-style".equals( key ) ) {
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Could not parse border-style " + value );
                return null;
            }
        }
        ...
        if ( "border-color".equals( key ) ) {
            try {
                ...
                Logger.e(WebEngageConstant.TAG, "Could not parse border-color " + value );
                return null;
            }
        }
