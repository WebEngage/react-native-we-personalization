...
import com.webengage.sdk.android.utils.htmlspanner.css.CompiledRule;
...
//                    + "' class='" + option(node.getAttributeByName("class")) + "'>");
    ...
    public void pushSpan( final Object span, final int start, final int end ) {
        ...
        if ( end > start ) {
            ...
            Logger.d(WebEngageConstant.TAG, "refusing to put span of type " + span.getClass().getSimpleName()
