...
package com.webengage.sdk.android.utils.htmlspanner.cssparser;
...
public final class PropertyValue {
	...
	public boolean equals(final Object object) {
		...
		if (object instanceof PropertyValue) {
			...
			return target.property.trim().equalsIgnoreCase(property.trim()) && target.value.trim().equalsIgnoreCase(value.trim());
