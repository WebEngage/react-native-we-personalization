...
// Tracking functions
export declare function trackClick(propertyId: string | number, attributes?: Record<string, any>): void;
export declare function trackImpression(propertyId: string | number, attributes?: Record<string, any>): void;
